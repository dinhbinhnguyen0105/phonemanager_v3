...
class Ui_page__facebooks(object):
    def setupUi(self, page__facebooks):
        ...
        self.page__facebook_actions_container.setGeometry(QRect(0, 0, 322, 443))
        ...
        self.page__facebooks_layout.addWidget(self.page__facebooks_actions_scrollarea, 2, 2, 1, 1)
        ...
        self.page__facebooks_buttons_start_btn = QPushButton(self.page__facebooks_buttons)
        self.page__facebooks_buttons_start_btn.setObjectName(u"page__facebooks_buttons_start_btn")

        self.page__facebooks_buttons_layout.addWidget(self.page__facebooks_buttons_start_btn)


        self.horizontalLayout_3.addLayout(self.page__facebooks_buttons_layout)


        self.page__facebooks_layout.addWidget(self.page__facebooks_buttons, 3, 2, 2, 1)
        ...
        self.page__facebooks_layout.addWidget(self.page__facebooks_actions_list, 1, 1, 5, 1)
        ...
        self.page__facebooks_layout.addWidget(self.page__facebooks_facebook_table, 1, 0, 5, 1)
        ...
        self.page__facebooks_layout.addWidget(self.page__facebooks_info_container, 0, 2, 2, 1)
    ...
    def retranslateUi(self, page__facebooks):
        ...
        self.page__facebooks_buttons_start_btn.setText(QCoreApplication.translate("page__facebooks", u"Start", None))
        ...
        self.page__facebooks_info__deviceudid_label.setText(QCoreApplication.translate("page__facebooks", u"Device's UDID:", None))
        self.page__facebooks_info__deviceudid_info.setText(QCoreApplication.translate("page__facebooks", u"---", None))
        self.page__facebooks_info__devicestatus_label.setText(QCoreApplication.translate("page__facebooks", u"Device's status", None))
